    ...
    //-------------------------------------------------------------------------------------------------------------    
    PVRTMatrixInverseExF(invertMatrix, modelView); 
    PVRTMatrixTransposeF(invertMatrix, invertMatrix);                                                                                                                        
    //======================================================================================================                                                                  
    ...
    glUniformMatrix4fv(UNIFORM_invertMatrix_facing_UP,    1,0,  invertMatrix);    
