...
//-----------------------------------------------------------------------------------------------------------------      
      ...
      "      mat3 tbnMatrix = mat3(eyeSpaceTangent.x, eyeSpaceBinormal.x, eyeSpaceNormal.x,                                                               \n"  
      "                            eyeSpaceTangent.y, eyeSpaceBinormal.y, eyeSpaceNormal.y,                                                               \n"  
      "                            eyeSpaceTangent.z, eyeSpaceBinormal.z, eyeSpaceNormal.z);                                                              \n"  
    
    
      "        vec3 vertexPosition   =  vec3(mvMatrix * position);                                              \n"        
      "        vec3 dirEye           =  vertexPosition;                                                         \n"  
      
     // "             dirEye.x         *=  zDirBias;                                                               \n"      
      //"             dirEye.z         =  zDirBias;                                                               \n"        
      
      "        EyeDir.x              =  dot(eyeSpaceTangent.xyz , dirEye);                                                    \n"  
      "        EyeDir.y              =  dot(eyeSpaceBinormal.xyz , dirEye);                                                    \n"  
      "        EyeDir.z              =  dot(eyeSpaceNormal.xyz , dirEye);                                                    \n"  
      //-----------------------------------------------------------------------------------------------------------------
      ...
      "         vec2 delta = vec2( EyeDir.x, EyeDir.y) / (EyeDir.z);                                                                    \n"  
      ...
      "         newTexCoord = varTexcoord.xy + (height * delta) * -EyeDir.z;                                                            \n"  
      ...
      "                               +  texture2D(Texture1, newTexCoord.xy) * pow(NdotL1, 50.0) * vec4(2.0, 1.0, .1, 1.0) * 0.2)  \n"                       
      "                               *  1.0;                                                                                   \n"
