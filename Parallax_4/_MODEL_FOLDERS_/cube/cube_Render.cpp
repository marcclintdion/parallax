    ...
    Rotate(modelView, cube_ROTATE[0], cube_ROTATE[1], cube_ROTATE[2], cube_ROTATE[3] + angle);                                                                      
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------------------|__LIGHT             
    LoadIdentity(invertMatrix);    
    
    ComputeInvModelMatrix(invertMatrix, modelView);     
    ...
    glUniform1f(UNIFORM_angle_cube, angle);
    glUniform1f(UNIFORM_scaleRadian_cube, cube_scaleRadian);         
    ...
    glUniformMatrix4fv(UNIFORM_invertMatrix_cube,    1,0,  invertMatrix);    
