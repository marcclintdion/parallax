...
void ComputeInvModelMatrix(float* mtx, const float* src)
{
	
	float invTranslation[16];
	float invRotation[16];
	
	
	invTranslation[0] = 1 ;	invTranslation[4] = 0 ;	invTranslation[8] = 0 ;		invTranslation[12] = -mtx[12] ;
	invTranslation[1] = 0 ;	invTranslation[5] = 1 ;	invTranslation[9] = 0 ;		invTranslation[13] = -mtx[13] ;
	invTranslation[2] = 0 ;	invTranslation[6] = 0 ;	invTranslation[10] = 1 ;	invTranslation[14] = -mtx[14] ;
	invTranslation[3] = 0 ;	invTranslation[7] = 0 ;	invTranslation[11] = 0 ;	invTranslation[15] = 1 ;
	
	invRotation[0] = mtx[0] ;		invRotation[4] = mtx[1] ;		invRotation[8] = mtx[2] ;		invRotation[12] = 0 ;
	invRotation[1] = mtx[4] ;		invRotation[5] = mtx[5] ;		invRotation[9] = mtx[6] ;		invRotation[13] = 0 ;
	invRotation[2] = mtx[8] ;		invRotation[6] = mtx[9] ;		invRotation[10] = mtx[10] ;		invRotation[14] = 0 ;
	invRotation[3] = 0 ;				invRotation[7] = 0 ;				invRotation[11] = 0 ;				invRotation[15] = 1 ;
	
	
	MultiplyMatrix(invRotation, invTranslation, src);
}
