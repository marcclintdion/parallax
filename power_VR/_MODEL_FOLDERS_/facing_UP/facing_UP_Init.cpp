...
*/                   
      ...
      "    	tempPos = mvMatrix * tempPos;                                                                                   \n" 
	
      "    	EyeDir = tempPos.xyz;                                                                                            \n" 
	
      "    	EyeDir = normalize(mEyeToTangent * EyeDir) * shininess;                                                    \n" 
...
//      "            vec2 tTexCoord = varTexcoord + (height * tEyeDir.xy);                                                                      \n" 
      ...
      "     highp float fDepth = texture2D(HeightMap, varTexcoord).x;                                                                               \n" 
      "     highp vec2 tTexCoord = varTexcoord + (fDepth * EyeDir.xy) ;                                                                             \n" 
