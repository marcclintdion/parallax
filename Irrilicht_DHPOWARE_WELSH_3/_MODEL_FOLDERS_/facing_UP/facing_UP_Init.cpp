      ...
      "    varying highp vec3   position_PASS;                                                                                                  \n"                  
           //-------------------------------------------------
      ...
      "           normal_PASS             = normal;                                                                                             \n"  
      "           position_PASS           = position.xyz;                                                                                       \n"       
              //-----------------------------------------------------------------------------------------------------------------
      "           vec3 pos                =  normalize(vec3(mvMatrix * position));                                                              \n" 
      "           vec3 Eye                =  vec3(0.0, 0.0, 1000.0) - pos;                                                                         \n" 
      ...
      "    varying highp vec3   position_PASSED;                                                                                                \n"          
...
*/
     ...
     //------------------------------------------------------------------------------------------------------------------------
      ...
      "                                +  texture2D(Texture1, tTexCoord.xy) * NdotL1 * NdotL1 * 0.5                                                      \n"                       

      "                                +  texture2D(Texture1, tTexCoord.xy) * pow(NdotL1, 200.0) * vec4(1.0, .5, .1, 1.0) * 0.5)                 \n"                       
