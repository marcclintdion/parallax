...
//######################################################################################################################
                              ...
                              var         facing_UP_ATTENUATION            =  -0.009;
                              var         facing_UP_SHININESS              =  0.0295;
...
void ProcessKeyboard(void)
{
   ...
   if (keys['V'])                                                                                                                      
    {	                                                                                                                                  
             facing_UP_ATTENUATION            =  -0.009;
             facing_UP_SHININESS              =  0.0295;                                                                            
    }	                                                                                                                                  
    if (keys['C'])                                                                                                                      
    {	                                                                                                                                  
             facing_UP_ATTENUATION            =  -0.0;
             facing_UP_SHININESS              =  0.00;                                                                           
    } 
