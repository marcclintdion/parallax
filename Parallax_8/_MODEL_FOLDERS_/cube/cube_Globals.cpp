...
GLuint      UNIFORM_angle_cube;   
GLuint      UNIFORM_scaleRadian_cube;                                                                                                
GLuint      UNIFORM_TEXTURE_HEIGHT_cube;
GLuint      UNIFORM_TEXTURE_DOT3_cube;
GLuint      UNIFORM_TEXTURE_cube;                                                                                                    
//--------------------------------------                                                                                                  
GLfloat     cube_POSITION[]            =  {  0.0, 0.0, -4.0, 1.0};                                                                    
GLfloat     cube_ROTATE[]              =  {  0.0, 1.0,  0.0, 0.0};                                                                   
GLfloat     cube_SCALE[]               =  {  1.0, 1.0,  1.0, 1.0};                                                                   

//============================================================================== 
//==============================================================================                                                                      
var         cube_LIGHT_POSITION_01[]    =  {4.6, 1.8, 5, 1.0};

var         cube_ATTENUATION            =  0.0327;
var         cube_SHININESS              =  0.0566001;
var         cube_scaleRadian            =  1.0;
//------------------------------------------------------------------------ 
